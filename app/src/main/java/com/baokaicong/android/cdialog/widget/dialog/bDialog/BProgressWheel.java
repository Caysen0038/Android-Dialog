 ...
 */
public class BProgressWheel extends View {
    private static final String TAG = BProgressWheel.class.getSimpleName();
     ...
     * @param attrs
     */
    public BProgressWheel(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     * @param context
     */
    public BProgressWheel(Context context) {
        super(context);
    }
