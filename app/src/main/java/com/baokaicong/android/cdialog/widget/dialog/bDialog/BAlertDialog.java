...
public class BAlertDialog {
    ...
    public BAlertDialog setEditText(String msg) {
        showEditText = true;
        if ("".equals(msg)) {
    ...
    public BAlertDialog setEditTextContent(String msg) {
        showEditText = true;
    ...
    public BAlertDialog setEditType(int editType) {
    ...
    public BAlertDialog setMsg(String msg) {
        showMsg = true;
        if ("".equals(msg)) {
    ...
    public BAlertDialog setView(View view) {
        showLayout = true;
        if (view == null) {
            showLayout = false;
        } else
    ...
    public BAlertDialog setCancelable(boolean cancel) {
        dialog.setCancelable(cancel);
        return this;
    }

    public BAlertDialog setCanceledOnTouchOutside(boolean cancel) {
        dialog.setCanceledOnTouchOutside(cancel);
        return this;
    }

    public BAlertDialog setPositiveButton(String text, final OnClickListener listener) {
        showPosBtn = true;
        if ("".equals(text)) {
    ...
    public BAlertDialog setPositiveButton(String text, final OnClickListener listener, final boolean isDismiss) {
        showPosBtn = true;
        if ("".equals(text)) {
            btn_pos.setText(context.getString(R.string.confirm));
        } else {
    ...
    public BAlertDialog setNegativeButton(String text, final OnClickListener listener) {
        showNegBtn = true;
        if ("".equals(text)) {
