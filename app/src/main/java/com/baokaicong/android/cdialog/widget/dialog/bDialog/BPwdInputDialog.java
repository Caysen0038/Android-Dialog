...
import com.baokaicong.basedialog.inputView.PasswordInputView;
import com.baokaicong.basedialog.widget.PasswordKeyboardView;


public class BPwdInputDialog {
    private Context              context;
    private Dialog               dialog;
    private Display              display;

    private PasswordKeyboardView mKeyBoardView;
    private PasswordInputView managerInputView;
    private StringBuilder        password = new StringBuilder();
    private TextView titleTv;

    public BPwdInputDialog(Context context) {
    ...
    public BPwdInputDialog builder() {
        // 获取Dialog布局
        ...
        managerInputView = (PasswordInputView) view.findViewById(R.id.input_manager_password);
    ...
    public BPwdInputDialog setTitle(String  title){
    ...
    public BPwdInputDialog setPasswordListener(final OnPasswordResultListener listener) {
    ...
    public BPwdInputDialog setCancelable(boolean cancel) {
        dialog.setCancelable(cancel);
        return this;
    }

    public BPwdInputDialog setCanceledOnTouchOutside(boolean cancel) {
