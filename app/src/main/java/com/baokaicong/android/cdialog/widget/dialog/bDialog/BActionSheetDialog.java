...
import com.baokaicong.basedialog.consts.SheetItemColor;

import java.util.ArrayList;
import java.util.List;


public class BActionSheetDialog {
    ...
    public BActionSheetDialog(Context context) {
    ...
    public BActionSheetDialog builder() {
        // 获取Dialog布局
    ...
    public BActionSheetDialog setTitle(String title) {
        showTitle = true;
    ...
    public BActionSheetDialog setCancelable(boolean cancel) {
        dialog.setCancelable(cancel);
        return this;
    }

    public BActionSheetDialog setCanceledOnTouchOutside(boolean cancel) {
     ...
     * @return
     */
    public BActionSheetDialog addSheetItem(String strItem, SheetItemColor color,
