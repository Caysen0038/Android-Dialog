...
public class BAlertInputDialog {
    ...
    public BAlertInputDialog(Context context) {
    ...
    public BAlertInputDialog builder() {
        // 获取Dialog布局
    ...
    public BAlertInputDialog setTitle(String title) {
        showTitle = true;
        if ("".equals(title)) {
            txt_title.setText("请输入");
        } else {
    ...
    public BAlertInputDialog setEditHint(String msg) {
        showEditText = true;
        if ("".equals(msg)) {
    ...
    public BAlertInputDialog setEditText(String msg) {
        showEditText = true;
        ...
        public BAlertInputDialog setEditType(int editType) {
    ...
    public BAlertInputDialog setMsg(String msg) {
        showMsg = true;
        if ("".equals(msg)) {
    ...
    public BAlertInputDialog setCancelable(boolean cancel) {
        dialog.setCancelable(cancel);
        return this;
    }

    public BAlertInputDialog setCanceledOnTouchOutside(boolean cancel) {
        dialog.setCanceledOnTouchOutside(cancel);
        return this;
    }

    public BAlertInputDialog setPositiveButton(String text, final OnClickListener listener) {
        showPosBtn = true;
        if ("".equals(text)) {
    ...
    public BAlertInputDialog setNegativeButton(String text, final OnClickListener listener) {
        showNegBtn = true;
        if ("".equals(text)) {
